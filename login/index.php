...
<body>
    <div class="overlay">
        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-eye-slash" viewBox="0 0 16 16">
    ...
    <main class="login">
        <div class="division" id="leftDiv">
            ...
            <h4 id="toggleText">Forgot your password?</h4>
            <p id="paragraph">Select the icon for more information</p>
        </div>
        <form class="division" action="/login/" id="rightDiv" method="post">
            <h2>Welcome back!</h2>
            <p><?php echo $msg ?></p>
