...
<body>
    ...
    height: 100%;">
        ...
        <ul class="nav mb-auto">
            ...
            <li>
                <a href="boxes/index.php" class="nav-link border-bottom">
                    <svg width="40" height="24" viewBox="0 0 16 16">
            ...
            <li>
                <a href="/materials/index.php" class="nav-link border-bottom">
            ...
            <li>
                <a href="/products/index.php" class="nav-link border-bottom">
                    <svg width="40" height="24" viewBox="0 0 16 16">
            ...
            <li>
                <a href="/protocols/index.php" class="nav-link border-bottom">
                    <svg width="40" height="24" viewBox="0 0 16 16">
                        <path
