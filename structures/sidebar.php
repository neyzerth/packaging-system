...
<body>
    ...
    height: 100%;">
        ...
        <ul class="nav mb-auto">
            <li>
                <a href="\GitHub\packaking-system/home/index.php" class="nav-link border-bottom">
            ...
            <li>
                <a href="\GitHub\packaking-system/boxes/index.php" class="nav-link border-bottom">
                    <svg width="40" height="24" viewBox="0 0 16 16">
            ...
            <li>
                <a href="\GitHub\packaking-system/materials/index.php" class="nav-link border-bottom">
            ...
            <li>
                <a href="\GitHub\packaking-system/products/index.php" class="nav-link border-bottom">
                    <svg width="40" height="24" viewBox="0 0 16 16">
            ...
            <li>
                <a href="\GitHub\packaking-system/protocols/index.php" class="nav-link border-bottom">
                    <svg width="40" height="24" viewBox="0 0 16 16">
                        <path
            ...
            <li>
                <a href="\GitHub\packaking-system/users/index.php" class="nav-link">
                    <svg width="40" height="24" viewBox="0 0 16 16">
